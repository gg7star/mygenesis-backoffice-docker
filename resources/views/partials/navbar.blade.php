  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{url('/')}}" style="font-family: serif;"><img style=" width: 65px; height: 50px; " src="{{ asset('My-genesis-logo.png') }}" alt="Back Office of Tina">Back Office of My Genesis
        </a>
      </div>
      <div id="navbar5" class="navbar-collapse collapse">
        <!-- <ul class="nav navbar-nav navbar-right">
          <li class=""><a href="{{url('jobs')}}">Jobs</a></li>
